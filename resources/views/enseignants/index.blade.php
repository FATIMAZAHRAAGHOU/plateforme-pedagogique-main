...
<div class="sidebar" id="sidebar">
    ...
    <a href="{{ route('enseignants.index') }}" class="active">
        <span>👨‍🏫</span>
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <small class="text-muted">
                    Administration des profils enseignants
                </small>
            </div>
        </div>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0">
                        Créer, modifier et supprimer les profils enseignants.
                    </p>
                </div>
                    ...
                    <tbody>
                        @foreach($enseignants as $enseignant)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('enseignants.edit', $enseignant->id) }}" class="btn btn-sm btn-warning">
                                        Modifier
                                    </a>
...
<script>
    ...
    function confirmDelete(button) {
        Swal.fire({
            title: 'Êtes-vous sûr ?',
            text: 'Cet enseignant sera supprimé définitivement.',
            icon: 'warning',
