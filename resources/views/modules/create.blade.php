...
<div class="container">
    <div class="card page-card">
        ...
        <div class="page-header">
            ...
            <p>Associer un module à un enseignant et à un groupe.</p>
        </div>

        <div class="card-body p-4">

            <div class="help-box mb-4">
                Ici, l’administrateur choisit le module, l’enseignant et le groupe. Cela permet de savoir quels étudiants appartiennent à chaque enseignant.
            </div>
