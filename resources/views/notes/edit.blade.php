...
<div class="container">
    <div class="card page-card">
        ...
        <div class="page-header">
            ...
            <p>Modifier la note d’un étudiant.</p>
        </div>

        <div class="card-body p-4">

            <div class="help-box mb-4">
                Cette page permet de mettre à jour une note déjà enregistrée.
            </div>
            ...
            <form action="{{ route('notes.update', $note->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" name="note" class="form-control" value="{{ old('note', $note->note) }}">
                </div>

                <div class="mb-3">
                    <label class="form-label">Appréciation</label>
                    <textarea name="appreciation" class="form-control">{{ old('appreciation', $note->appreciation) }}</textarea>
                </div>
