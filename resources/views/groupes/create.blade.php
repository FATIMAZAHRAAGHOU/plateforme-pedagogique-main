...
<div class="container">
    <div class="card page-card">
        ...
        <div class="page-header">
            ...
            <p>Associer un groupe à une filière.</p>
        </div>

        <div class="card-body p-4">

            <div class="help-box mb-4">
                Cette page permet de créer un groupe et de le lier à une filière.
            </div>
            ...
            <form action="{{ route('groupes.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="annee_scolaire" class="form-control" value="{{ old('annee_scolaire') }}">
                </div>
