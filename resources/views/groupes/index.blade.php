...
<div class="sidebar" id="sidebar">
    ...
    <a href="{{ route('groupes.index') }}" class="active">
        <span>👥</span>
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <small class="text-muted">
                    Administration des groupes des étudiants
                </small>
            </div>
        </div>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0">
                        Créer, modifier et supprimer les groupes liés aux filières.
                    </p>
                </div>
                    ...
                    <tbody>
                        @foreach($groupes as $groupe)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('groupes.edit', $groupe->id) }}" class="btn btn-sm btn-warning">
                                        Modifier
                                    </a>

                                    <form action="{{ route('groupes.destroy', $groupe->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
...
<script>
    ...
    function confirmDelete(button) {
        Swal.fire({
            title: 'Êtes-vous sûr ?',
            text: 'Ce groupe sera supprimé définitivement.',
            icon: 'warning',
