...
<div class="container">
    <div class="card page-card">
        ...
        <div class="page-header">
            ...
            <p>Modifier les informations d’une évaluation.</p>
        </div>

        <div class="card-body p-4">

            <div class="help-box mb-4">
                Cette page permet de mettre à jour une évaluation déjà créée.
            </div>
            ...
            <form action="{{ route('evaluations.update', $evaluation->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="titre" class="form-control" value="{{ old('titre', $evaluation->titre) }}">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="date" class="form-control" value="{{ old('date', $evaluation->date) }}">
                </div>

                <div class="mb-3">
                    <label class="form-label">Coefficient</label>
                    <input type="number" step="0.01" name="coefficient" class="form-control" value="{{ old('coefficient', $evaluation->coefficient) }}">
                </div>
